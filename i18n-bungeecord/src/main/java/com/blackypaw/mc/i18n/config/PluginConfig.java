...
public class PluginConfig extends SimpleConfig {
	...
	@Comment( "The interval in milliseconds in which to check for data whose owning player is no longer connected. Set to a negative value to disable but be aware of potential memory leaks!" )
	private long connectionWipeoutInterval = 5000L;
	...
	public long getConnectionWipeoutInterval() {
		return connectionWipeoutInterval;
	}
